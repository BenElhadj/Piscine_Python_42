...
class Baratheon(Character):
    ...
    def __str__(self):
        """Method for Baratheon: Return a string representation of the Baratheon family."""
        return f"Vector: ('{self.family_name}', '{self.eyes}', '{self.hairs}')"

    def __repr__(self):
        """Method for Baratheon: Return a formal string representation of the Baratheon family."""
        return self.__str__()
...
class Lannister(Character):
    ...
    def __str__(self):
        """Method for Lannister: Return a string representation of the Lannister family."""
        return f"Vector: ('{self.family_name}', '{self.eyes}', '{self.hairs}')"

    def __repr__(self):
        """Method for Lannister: Return a formal string representation of the Lannister family."""
        return self.__str__()
